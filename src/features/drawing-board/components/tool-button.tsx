...
export function ToolButton<T extends ValidComponent = "button">(
  ...
  return (
    <Dynamic
      ...
      class={cn(
        "btn btn-ghost btn-square data-[current-tool=true]:btn-soft data-[current-tool=true]:hover:bg-primary/20 data-[current-tool=true]:btn-primary data-[current-tool=true]:hover:text-primary data-[current-tool=true]:focus:bg-primary/20 data-[current-tool=true]:focus-within:bg-primary/20 border-0 shadow-none [&>svg]:size-5",
        props.class,
      )}
      {...rest}
    />
